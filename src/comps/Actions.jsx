        ...
        {actions.map(
          (action, index) =>
            action.text != status && (
              <li
                key={index}
                className="w-full text-left p-2 hover:bg-gray-100 rounded-lg pt-1 px-2 flex items-center text-sm text-gray-600 hover:text-black transition-all"
              >
                {action.icon}
                {action.text}
              </li>
